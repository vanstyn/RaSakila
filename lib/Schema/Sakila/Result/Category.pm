package Schema::Sakila::Result::Category;
...
Related object: L<Schema::Sakila::Result::FilmCategory>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Kbanu3WA0CxkFxaRJ3Cr6w
