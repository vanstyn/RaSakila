package Schema::GreenSheet::Result::DistributorType;
...
__PACKAGE__->table("distributor_type");
...
__PACKAGE__->has_many(
  ...
  { "foreign.office_type_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);


# Created by DBIx::Class::Schema::Loader v0.07010 @ 2013-03-18 14:34:08
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:pxHVkX3vPhFvX93mvo08PQ
