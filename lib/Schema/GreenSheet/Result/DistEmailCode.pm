package Schema::GreenSheet::Result::DistEmailCode;
...
__PACKAGE__->table("dist_email_code");
...
__PACKAGE__->has_many(
  ...
  { "foreign.email_code_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);


# Created by DBIx::Class::Schema::Loader v0.07010 @ 2013-03-18 14:34:08
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:KK3q3ayJq219UHSodlfjjg
