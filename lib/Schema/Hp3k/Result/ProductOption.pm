package Schema::Hp3k::Result::ProductOption;
...
__PACKAGE__->table("product_option");
...
__PACKAGE__->has_many(
  ...
  { "foreign.pc3" => "self.code" },
  { cascade_copy => 0, cascade_delete => 0 },
);


# Created by DBIx::Class::Schema::Loader v0.07010 @ 2013-03-18 14:30:02
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Wy2GC4+2Xvstkq4aNL0J6g
